...
//  */
// function ReservaConfirmModal({ show, handleClose, handleConfirm, loading, confirmData }) {
//     // Não renderiza nada se não tiver os dados
//     if (!confirmData) return null; 

//     return (
//         // zIndex alto para sobrepor o modal de Nova Reserva
//         <Modal show={show} onHide={handleClose} centered style={{ zIndex: 1060 }}>
//             <Modal.Header closeButton>
//                 <Modal.Title style={{ color: '#26522c' }}>Confirmar Reserva</Modal.Title>
//             </Modal.Header>
//             <Modal.Body>
...
//                         <strong className="status-pendente">{confirmData.forma_pagamento}</strong>
//                     </div>
//                 </div>
